...
export function addPadding(plaintext: Buffer, blockSize: number): Buffer {
  ...
  const paddingBuffer = Buffer.from(Array(pad).fill(pad));
  return Buffer.concat([plaintext, paddingBuffer]);
}

// https://github.com/gchq/CyberChef/blob/master/src/core/Utils.mjs
/**
 * @author n1474335 [n1474335@gmail.com]
 * @copyright Crown Copyright 2016
 * @license Apache-2.0
 */
export function getPrintable(str: string): string {
